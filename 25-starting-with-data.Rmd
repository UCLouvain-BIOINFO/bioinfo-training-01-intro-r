...
if (!file.exists("data/rnaseq.csv"))
    download.file(url = "https://uclouvain-cbio.github.io/WSBIM1207/data/rnaseq.csv",
...
It can also be downloaded [here](https://uclouvain-cbio.github.io/WSBIM1207/data/rnaseq.csv).
